...
shell.ShellString((IS_MAJOR ? '## ' : '### ') + CURRENT_TAG + P).toEnd(FILE);
shell.ShellString('#### Features' + P + features + P).toEnd(FILE);
shell.ShellString('#### Bugfixes' + P + others + EOL).toEnd(FILE);
