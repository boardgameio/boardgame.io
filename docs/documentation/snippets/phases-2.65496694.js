    ...
    'QH++': [
      function(require, module, exports) {
        ...
        var e = l(require('react')),
          ...
          a = require('boardgame.io/react');
        function l(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function r(e, t) {
          e.deck--, e.hand[t.currentPlayer]++;
        }
        function n(e, t) {
          e.deck++, e.hand[t.currentPlayer]--;
        }
        const d = {
            setup: e => ({ deck: 6, hand: Array(e.numPlayers).fill(0) }),
            phases: {
              draw: {
                moves: { DrawCard: r },
                endIf: e => e.deck <= 0,
          ...
          u = ({ G: t, ctx: a }) =>
            e.default.createElement(
              'div',
              { className: 'deck' },
              e.default.createElement('div', null, t.deck),
              e.default.createElement('div', null, 'cards'),
              e.default.createElement(
                'div',
                { style: { fontSize: '1.2em', marginTop: 20, color: '#aaa' } },
                a.phase
              )
            );
        function c(t) {
          const { playerID: a, isActive: l } = t;
          if (!a) return e.default.createElement(u, t);
          let r = 'client';
          return (
            l && (r += ' active'),
            e.default.createElement(
              ...
              e.default.createElement(
                'li',
                null,
                e.default.createElement('strong', null, 'Player ', a)
              ),
              e.default.createElement('li', null, t.G.hand[a], ' cards'),
              e.default.createElement(
                'li',
                null,
                e.default.createElement(
          ...
          m = () =>
            e.default.createElement(
              ...
              e.default.createElement(
                'div',
                { className: 'container' },
                e.default.createElement(i, { playerID: '0' }),
                e.default.createElement(i, { playerID: '1' }),
                e.default.createElement(i, { playerID: '2' })
              )
            );
        t.default.render(
      ...
      { react: '1n8/', 'react-dom': 'NKHc', 'boardgame.io/react': 'nBOz' },
    ],
  },
  {},
  ['QH++'],
