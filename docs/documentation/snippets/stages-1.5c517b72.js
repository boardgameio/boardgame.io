      ...
      function(require, module, exports) {
        ...
        !(function(e, t) {
          ...
          var u = { NULL: null },
            a = {
              ALL: { all: u.NULL },
              ALL_ONCE: { all: u.NULL, moveLimit: 1 },
              OTHERS: { others: u.NULL },
              OTHERS_ONCE: { others: u.NULL, moveLimit: 1 },
            },
            l = {
              STRIP_SECRETS: function(r, e, n) {
                var i = o({}, r);
                return (
                  void 0 !== i.secret && delete i.secret,
                  i.players && (i.players = t({}, n, i.players[n])),
                  i
                );
              },
            };
          (r.ActivePlayers = a),
            (r.INVALID_MOVE = 'INVALID_MOVE'),
            (r.Pass = function(r, e) {
              var t = [];
              void 0 !== r.passOrder && (t = r.passOrder);
              var n = e.playerID;
              return (
                (r = o({}, r, { passOrder: (t = [].concat(i(t), [n])) })),
                t.length >= e.numPlayers && (r = o({}, r, { allPassed: !0 })),
                r
              );
            }),
            (r.PlayerView = l),
            ...
            (r.TurnOrder = {
              ...
              CUSTOM_FROM: function(r) {
                return {
                  playOrder: function(e) {
                    return e[r];
                  },
                  first: function() {
                    return 0;
              ...
              SKIP: {
                ...
                next: function(r, e) {
                  if (!r.allPassed)
                    for (
                      var t = e.playOrderPos, n = 0;
                      n < e.playOrder.length;
                      n++
                    )
                      if (
    ...
    Egi7: [
      function(require, module, exports) {
        ...
        var n = {
          ...
          game: {
            moves: { move: e => e },
            turn: { activePlayers: t.ActivePlayers.ALL },
            events: { endPhase: !1 },
          },
        };
        exports.default = n;
      },
      { react: '1n8/', 'boardgame.io/core': 'q71p' },
    ],
    Bh5V: [
      function(require, module, exports) {
        'use strict';
        ...
        var n = {
          ...
          game: {
            moves: { move: e => e },
            turn: { activePlayers: t.ActivePlayers.ALL_ONCE },
            events: { endPhase: !1 },
          },
        };
        exports.default = n;
      ...
      function(require, module, exports) {
        ...
        var n = {
          ...
          game: {
            moves: { move: e => e },
            events: { endPhase: !1 },
            turn: { activePlayers: t.ActivePlayers.OTHERS },
          },
        };
        exports.default = n;
      },
      ...
      function(require, module, exports) {
        ...
        var r = {
          ...
          game: {
            ...
            moves: {
              play: (e, t) => (
                t.events.setActivePlayers({ others: 'discard', moveLimit: 1 }),
                e
              ),
            },
            turn: { stages: { discard: { moves: { discard: e => e } } } },
          },
        };
        exports.default = r;
      },
    ...
    DeyK: [
      function(require, module, exports) {
        ...
        var e = n(require('react')),
          t = require('boardgame.io/react'),
          a = n(require('./example-all')),
          l = n(require('./example-all-once')),
          r = n(require('./example-others')),
          i = n(require('./example-others-once'));
        function n(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function s({ ctx: t, moves: a, events: l, playerID: r }) {
          if (null === r)
          ...
          return (
            t.activePlayers
              ? r in t.activePlayers &&
                ((n += ' active'), (s = !0), (i = t.activePlayers[r]))
              : r === t.currentPlayer && ((n += ' active'), (s = !0)),
            r == t.currentPlayer && ((n += ' current'), (c = !0)),
            (a = Object.entries(a)
              .filter(e => !('play' === e[0] && 'discard' === i))
              .filter(e => !('discard' === e[0] && 'discard' !== i))
              .map(t =>
                e.default.createElement(
                  'button',
                  { key: t[0], onClick: () => t[1]() },
            ...
            (l = Object.entries(l)
              .filter(() => c && s)
              .filter(e => 'setActivePlayers' != e[0])
              .filter(e => 'setStage' != e[0])
              .filter(e => 'endStage' != e[0])
              .map(t =>
                e.default.createElement(
                  'button',
                  { key: t[0], onClick: () => t[1]() },
        ...
        class d extends e.default.Component {
          constructor(e) {
            super(e), this.init('all');
          }
          init(e) {
            let a = !1;
            void 0 !== this.client && (a = !0),
              (this.type = e),
              (this.description = c[e].description),
              (this.client = (0, t.Client)({
                game: c[e].game,
                numPlayers: 6,
                debug: !1,
                board: s,
            ...
            return e.default.createElement(
              ...
              e.default.createElement(
                ...
                e.default.createElement(
                  'div',
                  {
                    className: 'others-once' === this.type ? 'active' : '',
              ...
              e.default.createElement(
                ...
                e.default.createElement(
                  ...
                  e.default.createElement(a, { gameID: this.type }),
                  e.default.createElement('span', null, l)
                ),
                e.default.createElement(
                  'div',
                  { className: 'description' },
                  e.default.createElement(t, null)
                )
              )
            );
          }
      ...
      },
      {
        ...
        './example-all': 'Egi7',
        './example-all-once': 'Bh5V',
        './example-others': 'owGk',
        './example-others-once': '9ofi',
        './simulator.css': '70rD',
      },
    ],
    k7Rb: [
      ...
      { react: '1n8/', 'react-dom': 'NKHc', './simulator': 'DeyK' },
    ],
  },
  {},
  ['k7Rb'],
