...
test('activating undo / redo functionality', () => {
  {
    ...
    expect(client.undo).toBeDefined();
    expect(client.redo).toBeDefined();
  }

  {
    // deactivated with empty undoableMoves array
    const game = Game({
      flow: {
        undoableMoves: [],
      },
    ...
    expect(client.undo).toBeUndefined();
    expect(client.redo).toBeUndefined();
  }

  {
    // activated with filled undoableMoves array
    const game = Game({
      flow: {
        undoableMoves: ['A'],
      },
